...
keras_compile(mod,  loss = 'binary_crossentropy', metrics = c('binary_crossentropy'), optimizer = RMSprop())
set.seed(12345)
keras_fit(mod, trainX, trainX, validation_data = list(valX, valX), batch_size = 100, epochs = 25, callbacks = callbacks, verbose = 1)
```


This condenses the images from $90 \times 160$ pixel images down to $78 \times 148$. Let's plot a few of the examples to see how well we have done at condensing then reconstructing images on some of the test data:
